...
// REUIRES: swift_feature_BorrowAndMutateAccessors
...
// CHECK-LABEL: sil hidden [ossa] @$s25borrow_accessor_evolution7WrapperV1kAA5KlassCvb : $@convention(method) (@in_guaranteed Wrapper) -> @guaranteed_addr Klass {
// CHECK: bb0([[REG0:%.*]] : $*Wrapper):
// CHECK:   debug_value [[REG0]], let, name "self", argno 1, expr op_deref
...
// CHECK-LABEL: sil hidden [ossa] @$s25borrow_accessor_evolution7WrapperV7nested1AA5KlassCvb : $@convention(method) (@in_guaranteed Wrapper) -> @guaranteed_addr Klass {
// CHECK: bb0([[REG0:%.*]] : $*Wrapper):
// CHECK:   debug_value [[REG0]], let, name "self", argno 1, expr op_deref
// CHECK:   [[REG2:%.*]] = struct_element_addr [[REG0]], #Wrapper._s
// CHECK:   [[REG3:%.*]] = function_ref @$s25borrow_accessor_evolution1SV1kAA5KlassCvb : $@convention(method) (@in_guaranteed S) -> @guaranteed_addr Klass
// CHECK:   [[REG4:%.*]] = apply [[REG3]]([[REG2]]) : $@convention(method) (@in_guaranteed S) -> @guaranteed_addr Klass
// CHECK:   return [[REG4]]
// CHECK: }

// CHECK-LABEL: sil hidden [ossa] @$s25borrow_accessor_evolution7WrapperV7nested2AA5KlassCvb : $@convention(method) (@in_guaranteed Wrapper) -> @guaranteed_addr Klass {
// CHECK: bb0([[REG0:%.*]] : $*Wrapper):
// CHECK:   debug_value [[REG0]], let, name "self", argno 1, expr op_deref
// CHECK:   [[REG2:%.*]] = function_ref @$s25borrow_accessor_evolution7WrapperV1kAA5KlassCvb : $@convention(method) (@in_guaranteed Wrapper) -> @guaranteed_addr Klass
// CHECK:   [[REG3:%.*]] = apply [[REG2]]([[REG0]]) : $@convention(method) (@in_guaranteed Wrapper) -> @guaranteed_addr Klass
// CHECK:   return [[REG3]]
// CHECK: }

// CHECK-LABEL: sil hidden [ossa] @$s25borrow_accessor_evolution7WrapperVyAA5KlassCSicib : $@convention(method) (Int, @in_guaranteed Wrapper) -> @guaranteed_addr Klass {
...
// CHECK-LABEL: sil hidden [ossa] @$s25borrow_accessor_evolution7WrapperV16nested_subscriptAA5KlassCvb : $@convention(method) (@in_guaranteed Wrapper) -> @guaranteed_addr Klass {
// CHECK: bb0([[REG0:%.*]] : $*Wrapper):
// CHECK:   debug_value [[REG0]], let, name "self", argno 1, expr op_deref
...
// CHECK:   [[REG6:%.*]] = function_ref @$s25borrow_accessor_evolution7WrapperVyAA5KlassCSicib : $@convention(method) (Int, @in_guaranteed Wrapper) -> @guaranteed_addr Klass
// CHECK:   [[REG7:%.*]] = apply [[REG6]]([[REG5]], [[REG0]]) : $@convention(method) (Int, @in_guaranteed Wrapper) -> @guaranteed_addr Klass
// CHECK:   return [[REG7]]
// CHECK: }
