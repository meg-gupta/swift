// RUN: %swift-frontend %s  -emit-silgen -target arm64e-apple-ios13.0 -I %S/Inputs/ 2>&1 | %FileCheck %s

import PointerAuth

// CHECK-LABEL: sil hidden [ossa] @$s25ptrauth_field_fptr_import05test_B8_fn_ptr1s5Int32VyF :
...
// CHECK: [[ELEM1:%.*]] = struct_element_addr [[A2]] : $*SecureStruct, #SecureStruct.secure_func_ptr 
...
// CHECK-LABEL: } // end sil function '$s25ptrauth_field_fptr_import05test_B8_fn_ptr1s5Int32VyF'
func test_field_fn_ptr1() -> Int32 {
