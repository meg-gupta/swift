...
func asyncLet_Let_ActorIsolated_Simple1() async {
  ...
  // expected-ni-ns-note @-2 {{sending 'x' to main actor-isolated global function 'transferToMainInt' risks causing data races between main actor-isolated and local nonisolated uses}}
...
func asyncLet_Let_ActorIsolated_CallBuriedInOtherExpr1() async {
  ...
  // expected-ni-ns-note @-5 {{sending 'x2' to main actor-isolated global function 'transferToMainInt' risks causing data races between main actor-isolated and local nonisolated uses}}
...
func asyncLet_Let_ActorIsolated_CallBuriedInOtherExpr4() async {
  ...
  // expected-ni-ns-note @-3:26 {{sending 'x' to main actor-isolated global function 'transferToMainInt' risks causing data races between main actor-isolated and local nonisolated uses}}
...
func asyncLet_Let_ActorIsolated_CallBuriedInOtherExpr5() async {
  ...
  // expected-ni-ns-note @-3 {{sending 'x' to main actor-isolated global function 'transferToMainInt' risks causing data races between main actor-isolated and local nonisolated uses}}
  // expected-note @-4:49 {{access can happen concurrently}}
...
func asyncLet_Let_ActorIsolated_MultipleAsyncLet3() async {
  ...
  // expected-ni-ns-note @-3 {{sending 'x2' to main actor-isolated global function 'transferToMainInt' risks causing data races between main actor-isolated and local nonisolated uses}}
...
func asyncLet_Let_ActorIsolated_MultipleAsyncLet4() async {
  ...
  // expected-ni-ns-note @-6 {{sending 'x2' to main actor-isolated global function 'transferToMainInt' risks causing data races between main actor-isolated and local nonisolated uses}}
...
func asyncLetWithoutCapture() async {
  ...
  // expected-ni-ns-warning @-2 {{non-Sendable 'NonSendableKlass'-typed result can not be returned from main actor-isolated global function 'returnValueFromMain()' to nonisolated context}}
  let y = await x
...
func asyncLet_Let_ActorIsolated_Method() async {
  ...
  // expected-ni-ns-note @-2 {{sending 'x' to actor-isolated instance method 'useKlass' risks causing data races between actor-isolated and local nonisolated uses}}
