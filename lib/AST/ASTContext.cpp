...
FunctionType *FunctionType::get(ArrayRef<AnyFunctionType::Param> params,
  ...
  bool hasLifetimeDependenceInfo =
      info.has_value() ? !info->getLifetimeDependenceInfo().empty() : false;
  auto numLifetimeDependencies =
      hasLifetimeDependenceInfo ? info->getLifetimeDependenceInfo().size() : 0;
...
SILFunctionType::SILFunctionType(
  ...
  if (!ext.getLifetimeDependenceInfo().empty()) {
    NumLifetimeDependencies = getLifetimeDependenceInfo().size();
    memcpy(getMutableLifetimeDependenceInfo().data(),
           getLifetimeDependenceInfo().data(),
...
CanSILFunctionType SILFunctionType::get(
  ...
  size_t bytes = totalSizeToAlloc<SILParameterInfo, SILResultInfo, SILYieldInfo,
      ...
      !ext.getLifetimeDependenceInfo().empty()
          ? ext.getLifetimeDependenceInfo().size()
          : 0);
