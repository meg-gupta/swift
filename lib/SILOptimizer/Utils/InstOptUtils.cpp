...
SILValue swift::makeCopiedValueAvailable(
  ...
  auto *copy = SILBuilderWithScope(insertPt).createCopyValue(
...
void swift::endLifetimeAtLeakingBlocks(
    SILValue value, ArrayRef<SILBasicBlock *> uses,
    JointPostDominanceSetComputer *jointPostDomComputer) {
  if (!value->getFunction()->hasOwnership())
    return ;
