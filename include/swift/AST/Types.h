...
protected:
  ...
  SWIFT_INLINE_BITFIELD_FULL(
      AnyFunctionType, TypeBase, NumAFTExtInfoBits + 1 + 1 + 1 + 1 + 16,
      /// Extra information which affects how the function is called, like
      /// regparm and the calling convention.
      ExtInfoBits
      : NumAFTExtInfoBits, HasExtInfo : 1, HasClangTypeInfo : 1,
        HasGlobalActor : 1, HasPointerAuthQualifier : 1,
      : NumPadBits, NumParams : 16);
